...
import {columns, mockTask, taskFieldsDetails, tasksFieldsInitialValues} from '@/components/pages/tasks-utils/constants'
    ...
    return (
      <div className="flex-1  flex-col items-center gap-2 ">
        ...
        <div className="flex-1 bg-black z-50 justify-around flex flex-row gap-4 py-2 w-full">
          {Object.entries(taskFieldsDetails).map((k, idx) => (
            <form.Field
              name={k[0] as keyof typeof tasksFieldsInitialValues}
              validators={{
                  ...
                  >
                    {cell.getValue() !== undefined ? (
                      ...
                      <div
                        onClick={() => {
                          console.log(
                            "Chamar api pra deletar a tarefa",
                            mockTask[row.index].name,
                          );
                        }}
